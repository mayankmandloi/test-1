import { fetchMovieDetail, fetchMoviesIfNeeded, fetchTrailerList} from 'actions/movie-actions';
import { FETCH_MOVIES, FETCH_TRAILERS, FETCH_MOVIE_DETAIL } from 'actions/movie-actions';
